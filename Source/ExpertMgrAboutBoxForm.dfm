object frmExpertMgrAboutBox: TfrmExpertMgrAboutBox
  Left = 0
  Top = 0
  ...
  object pnlFudge: TPanel
    ...
    object lblInformation: TMemo
      ...
      Align = alClient
      Lines.Strings = (
        'Expert and Pacakge Manager for Multiple RAD Studio IDEe'
        ''
        
          'Copyright (C) 2019  David Hoyle (https://github.com/DGH2112/Expe' +
          'rt-Manager/)'
        ''
